...
:root {
  ...
  --cds-global-layout-width-xs: 28.80rem;
  --cds-global-layout-width-sm: 38.40rem;
  --cds-global-layout-width-md: 49.60rem;
  --cds-global-layout-width-lg: 60.00rem;
  --cds-global-layout-width-xl: 72.00rem;
  --cds-global-space-0: 0.00rem;
  --cds-global-space-1: 0.05rem;
  --cds-global-space-2: 0.10rem;
  --cds-global-space-3: 0.20rem;
  --cds-global-space-4: 0.30rem;
  --cds-global-space-5: 0.40rem;
  --cds-global-space-6: 0.60rem;
  --cds-global-space-7: 0.80rem;
  --cds-global-space-8: 0.90rem;
  --cds-global-space-9: 1.20rem;
  --cds-global-space-10: 1.60rem;
  --cds-global-space-11: 1.80rem;
  --cds-global-space-12: 2.40rem;
  --cds-global-space-13: 3.60rem;
  ...
  --cds-global-typography-font-size-0: 0.50rem;
  --cds-global-typography-font-size-1: 0.55rem;
  --cds-global-typography-font-size-2: 0.60rem;
  --cds-global-typography-font-size-3: 0.65rem;
  --cds-global-typography-font-size-4: 0.70rem;
  --cds-global-typography-font-size-5: 0.80rem;
  --cds-global-typography-font-size-6: 1.00rem;
  --cds-global-typography-font-size-7: 1.20rem;
  --cds-global-typography-font-size-8: 1.60rem;
  --cds-global-typography-font-size-9: 2.00rem;
  --cds-global-typography-base-font-size: 125%;
  --cds-global-typography-base-font-size-px: 1.00rem;
  ...
  --cds-global-typography-body-font-size: 0.70rem;
  ...
  --cds-global-typography-display-font-size: 2.00rem;
  ...
  --cds-global-typography-heading-font-size: 1.60rem;
  ...
  --cds-global-typography-title-font-size: 1.20rem;
  ...
  --cds-global-typography-section-font-size: 1.00rem;
  ...
  --cds-global-typography-subsection-font-size: 0.80rem;
  ...
  --cds-global-typography-smallcaption-font-size: 0.50rem;
  ...
  --cds-alias-object-border-radius-100: 0.20rem;
  --cds-alias-object-border-radius-200: 0.60rem;
  --cds-alias-object-border-radius-300: 50%;
  --cds-alias-object-border-width-100: 0.05rem;
  --cds-alias-object-border-width-200: 0.10rem;
  --cds-alias-object-border-width-300: 0.15rem;
  --cds-alias-object-border-width-400: 0.20rem;
...
[cds-base-font='16'] {
  ...
  --cds-global-layout-space-xxs: 0.1250rem;
  --cds-global-layout-space-xs: 0.2500rem;
  --cds-global-layout-space-sm: 0.3750rem;
  --cds-global-layout-space-md: 0.7500rem;
  --cds-global-layout-space-lg: 1.5000rem;
  --cds-global-layout-space-xl: 3.0000rem;
  --cds-global-layout-space-xxl: 6.0000rem;
  --cds-global-layout-grid-cols: 12;
  --cds-global-layout-width-xs: 36.0000rem;
  --cds-global-layout-width-sm: 48.0000rem;
  --cds-global-layout-width-md: 62.0000rem;
  --cds-global-layout-width-lg: 75.0000rem;
  --cds-global-layout-width-xl: 90.0000rem;
  --cds-global-space-0: 0.0000rem;
  --cds-global-space-1: 0.0625rem;
  --cds-global-space-2: 0.1250rem;
  --cds-global-space-3: 0.2500rem;
  --cds-global-space-4: 0.3750rem;
  --cds-global-space-5: 0.5000rem;
  --cds-global-space-6: 0.7500rem;
  --cds-global-space-7: 1.0000rem;
  --cds-global-space-8: 1.1250rem;
  --cds-global-space-9: 1.5000rem;
  --cds-global-space-10: 2.0000rem;
  --cds-global-space-11: 2.2500rem;
  --cds-global-space-12: 3.0000rem;
  --cds-global-space-13: 4.5000rem;
  --cds-global-typography-font-size-0: 0.6250rem;
  --cds-global-typography-font-size-1: 0.6875rem;
  --cds-global-typography-font-size-2: 0.7500rem;
  --cds-global-typography-font-size-3: 0.8125rem;
  --cds-global-typography-font-size-4: 0.8750rem;
  --cds-global-typography-font-size-5: 1.0000rem;
  --cds-global-typography-font-size-6: 1.2500rem;
  --cds-global-typography-font-size-7: 1.5000rem;
  --cds-global-typography-font-size-8: 2.0000rem;
  --cds-global-typography-font-size-9: 2.5000rem;
  --cds-global-typography-base-font-size-px: 1.2500rem;
  --cds-global-typography-body-font-size: 0.8750rem;
  --cds-global-typography-display-font-size: 2.5000rem;
  --cds-global-typography-heading-font-size: 2.0000rem;
  --cds-global-typography-title-font-size: 1.5000rem;
  --cds-global-typography-section-font-size: 1.2500rem;
  --cds-global-typography-subsection-font-size: 1.0000rem;
  --cds-global-typography-message-font-size: 1.0000rem;
  --cds-global-typography-message-font-weight: 25.0000rem;
  --cds-global-typography-secondary-font-size: 0.8125rem;
  --cds-global-typography-caption-font-size: 0.6875rem;
  --cds-global-typography-smallcaption-font-size: 0.6250rem;
  --cds-alias-object-border-radius-100: 0.2500rem;
  --cds-alias-object-border-radius-200: 0.7500rem;
  --cds-alias-object-border-width-100: 0.0625rem;
  --cds-alias-object-border-width-200: 0.1250rem;
