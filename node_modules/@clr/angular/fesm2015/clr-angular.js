import { Directive, NgModule, Injectable, Renderer2, Inject, PLATFORM_ID, EventEmitter, ViewContainerRef, TemplateRef, Input, Output, HostListener, ElementRef, Optional, Component, SkipSelf, ViewChild, ɵɵdefineInjectable, InjectionToken, ContentChildren, ComponentFactoryResolver, Type, Injector, HostBinding, ContentChild, Self, Attribute, NgZone, LOCALE_ID, RendererFactory2, ChangeDetectorRef, IterableDiffers, ChangeDetectionStrategy, ɵɵinject } from '@angular/core';
...
import { filter, debounceTime, first, switchMap, take, map, startWith, tap, distinctUntilChanged } from 'rxjs/operators';
...
ClrControlSuccess.ctorParameters = () => [
    { type: ControlIdService, decorators: [{ type: Optional }] },
    { type: ContainerIdService, decorators: [{ type: Optional }] }
];
...
ClrControlHelper.ctorParameters = () => [
    { type: ControlIdService, decorators: [{ type: Optional }] },
    { type: ContainerIdService, decorators: [{ type: Optional }] }
];
...
ClrCheckboxModule.ctorParameters = () => [];
...
ClrDateInput.ctorParameters = () => [
    ...
    { type: undefined, decorators: [{ type: Inject, args: [PLATFORM_ID,] }] },
    { type: FocusService$1, decorators: [{ type: Optional }] },
    { type: DatepickerFocusService }
];
...
ClrDatepickerModule.ctorParameters = () => [];
...
ClrPasswordModule.ctorParameters = () => [];
...
ClrSelectModule.ctorParameters = () => [];
...
ClrTextareaModule.ctorParameters = () => [];
...
ClrOptionSelected.propDecorators = {
    selected: [{ type: Input, args: ['clrOptionSelected',] }]
};
...
DatagridFilterRegistrar.ctorParameters = () => [
...
ClrTreeNodeLink.ctorParameters = () => [
    { type: ElementRef }
];
...
ClrTimeline.propDecorators = {
    layout: [{ type: Input, args: ['clrLayout',] }],
    isVertical: [{ type: HostBinding, args: ['class.clr-timeline-vertical',] }]
};
