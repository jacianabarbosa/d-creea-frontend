...
import * as ɵngcc1 from './header';
import * as ɵngcc2 from './nav-level';
import * as ɵngcc3 from './chocolate/nav-detection-oompa-loompa';
import * as ɵngcc4 from './chocolate/main-container-willy-wonka';
import * as ɵngcc5 from '@angular/common';
import * as ɵngcc6 from '../../icon/icon.module';
import * as ɵngcc7 from '../../popover/dropdown/dropdown.module';
